...
namespace statiskit
{
    ...
    {              
        ...
        NegativeBinomialRegression::NegativeBinomialRegression(const unsigned int& kappa, const ScalarPredictor& predictor, const NegativeBinomialLink& link) :  DiscreteGeneralizedLinearModel< NegativeBinomialLink >(predictor, link)
