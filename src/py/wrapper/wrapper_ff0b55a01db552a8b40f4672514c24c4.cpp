...
void wrapper_ff0b55a01db552a8b40f4672514c24c4()
{
    ...
    void  (::statiskit::glm::GeneralizedLinearModel< ::statiskit::DiscreteUnivariateConditionalDistribution, ::statiskit::NegativeBinomialLink >::*method_pointer_4ad32f6a6b2559bbab42efd316205924)(class ::statiskit::ScalarPredictor const &) = &::statiskit::glm::GeneralizedLinearModel< struct ::statiskit::DiscreteUnivariateConditionalDistribution, struct ::statiskit::NegativeBinomialLink >::set_predictor;
    struct ::statiskit::NegativeBinomialLink * (::statiskit::glm::GeneralizedLinearModel< ::statiskit::DiscreteUnivariateConditionalDistribution, ::statiskit::NegativeBinomialLink >::*method_pointer_a404f3098b5d5f998ebc3c91e4856521)() const = &::statiskit::glm::GeneralizedLinearModel< struct ::statiskit::DiscreteUnivariateConditionalDistribution, struct ::statiskit::NegativeBinomialLink >::get_link;
    ...
    class_ff0b55a01db552a8b40f4672514c24c4.def("set_predictor", method_pointer_4ad32f6a6b2559bbab42efd316205924, "");
