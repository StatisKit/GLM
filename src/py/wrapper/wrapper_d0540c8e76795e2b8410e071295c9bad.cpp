...
void wrapper_d0540c8e76795e2b8410e071295c9bad()
{
    ...
    double const & (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::NegativeBinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_c9dc969b533d55898db6352908fbb0b8)() const = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::NegativeBinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_epsilon;
    void  (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::NegativeBinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_a351cab77cf25dbdad6085fdff83618c)(double const &) = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::NegativeBinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_epsilon;
    unsigned int const & (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::NegativeBinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_904d3ba09b3550358d9398dff9b4e7c2)() const = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::NegativeBinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_maxits;
    void  (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::NegativeBinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_aa9d4e80257c5c0dabf27f5c287039e0)(unsigned int const &) = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::NegativeBinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_maxits;
    ...
    boost::python::class_< autowig::Wrap_d0540c8e76795e2b8410e071295c9bad, autowig::Held< autowig::Wrap_d0540c8e76795e2b8410e071295c9bad >::Type, boost::python::bases< struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation::Estimator >, boost::noncopyable > class_d0540c8e76795e2b8410e071295c9bad("Estimator", "", boost::python::no_init);
    class_d0540c8e76795e2b8410e071295c9bad.def("get_epsilon", method_pointer_c9dc969b533d55898db6352908fbb0b8, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_d0540c8e76795e2b8410e071295c9bad.def("set_epsilon", method_pointer_a351cab77cf25dbdad6085fdff83618c, "");
    class_d0540c8e76795e2b8410e071295c9bad.def("get_maxits", method_pointer_904d3ba09b3550358d9398dff9b4e7c2, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_d0540c8e76795e2b8410e071295c9bad.def("set_maxits", method_pointer_aa9d4e80257c5c0dabf27f5c287039e0, "");
