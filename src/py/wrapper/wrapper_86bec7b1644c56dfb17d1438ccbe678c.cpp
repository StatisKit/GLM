...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< struct ::statiskit::glm::Design, ::statiskit::glm::ConstrainedDesign, struct ::statiskit::glm::Design > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< struct ::statiskit::glm::Design, ::statiskit::glm::ConstrainedDesign, struct ::statiskit::glm::Design >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::glm::Design, struct ::std::default_delete< struct ::statiskit::glm::Design > >  return_type_999c253e0e93518d96ad9031fdebaf79;
            virtual return_type_999c253e0e93518d96ad9031fdebaf79 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_999c253e0e93518d96ad9031fdebaf79, class_type, copy, ); };
