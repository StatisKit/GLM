...
void wrapper_a460842ca906536eaa9a4ff41e647b24()
{
    ...
    double const & (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::NominalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_905155fd21a25975b34682e0f66955c6)() const = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::NominalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_epsilon;
    void  (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::NominalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_a3a65b964fa15578841a4de3d8759b17)(double const &) = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::NominalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_epsilon;
    unsigned int const & (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::NominalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_38ab3121935e5f55b168dfbe61ece713)() const = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::NominalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_maxits;
    void  (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::NominalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_f1b730aaa1a15ed0b8832fd1192d6a81)(unsigned int const &) = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::NominalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_maxits;
    ...
    boost::python::class_< autowig::Wrap_a460842ca906536eaa9a4ff41e647b24, autowig::Held< autowig::Wrap_a460842ca906536eaa9a4ff41e647b24 >::Type, boost::python::bases< struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation::Estimator >, boost::noncopyable > class_a460842ca906536eaa9a4ff41e647b24("Estimator", "", boost::python::no_init);
    class_a460842ca906536eaa9a4ff41e647b24.def("get_epsilon", method_pointer_905155fd21a25975b34682e0f66955c6, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_a460842ca906536eaa9a4ff41e647b24.def("set_epsilon", method_pointer_a3a65b964fa15578841a4de3d8759b17, "");
    class_a460842ca906536eaa9a4ff41e647b24.def("get_maxits", method_pointer_38ab3121935e5f55b168dfbe61ece713, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_a460842ca906536eaa9a4ff41e647b24.def("set_maxits", method_pointer_f1b730aaa1a15ed0b8832fd1192d6a81, "");
