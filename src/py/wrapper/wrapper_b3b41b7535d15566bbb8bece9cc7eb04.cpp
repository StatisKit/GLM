...
void wrapper_b3b41b7535d15566bbb8bece9cc7eb04()
{
    ...
    class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > const & (::statiskit::glm::CategoricalRegressionFisherEstimation< ::statiskit::glm::NominalRegression >::Estimator::*method_pointer_949803a88cb2591caea744016dd72b83)() const = &::statiskit::glm::CategoricalRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator::get_beta_init;
    void  (::statiskit::glm::CategoricalRegressionFisherEstimation< ::statiskit::glm::NominalRegression >::Estimator::*method_pointer_76977dd3f5df5417bc189e7e631b5452)(class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > const &) = &::statiskit::glm::CategoricalRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator::set_beta_init;
    enum ::statiskit::glm::CategoricalRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator::initialization_type const & (::statiskit::glm::CategoricalRegressionFisherEstimation< ::statiskit::glm::NominalRegression >::Estimator::*method_pointer_8d825306999e5eafb7681710654a8eed)() const = &::statiskit::glm::CategoricalRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator::get_init;
    void  (::statiskit::glm::CategoricalRegressionFisherEstimation< ::statiskit::glm::NominalRegression >::Estimator::*method_pointer_90a4e3927c7c5e4a8a771e87a4ba6804)(enum ::statiskit::glm::CategoricalRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator::initialization_type const &) = &::statiskit::glm::CategoricalRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator::set_init;
    ...
    class_b3b41b7535d15566bbb8bece9cc7eb04.def("get_beta_init", method_pointer_949803a88cb2591caea744016dd72b83, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_b3b41b7535d15566bbb8bece9cc7eb04.def("set_beta_init", method_pointer_76977dd3f5df5417bc189e7e631b5452, "");
    class_b3b41b7535d15566bbb8bece9cc7eb04.def("get_init", method_pointer_8d825306999e5eafb7681710654a8eed, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_b3b41b7535d15566bbb8bece9cc7eb04.def("set_init", method_pointer_90a4e3927c7c5e4a8a771e87a4ba6804, "");
