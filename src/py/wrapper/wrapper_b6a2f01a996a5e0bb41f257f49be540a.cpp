...
void wrapper_b6a2f01a996a5e0bb41f257f49be540a()
{
    ...
    boost::python::class_< class ::statiskit::glm::NominalRegressionFisherEstimation< class ::statiskit::glm::CompleteRegressionFisherEstimation< class ::statiskit::glm::NominalRegression > >::Estimator, autowig::Held< class ::statiskit::glm::NominalRegressionFisherEstimation< class ::statiskit::glm::CompleteRegressionFisherEstimation< class ::statiskit::glm::NominalRegression > >::Estimator >::Type, boost::python::bases< class ::statiskit::glm::CompleteRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator > > class_b6a2f01a996a5e0bb41f257f49be540a("Estimator", "", boost::python::no_init);
    ...
    {
        boost::python::implicitly_convertible< autowig::Held< class ::statiskit::glm::NominalRegressionFisherEstimation< class ::statiskit::glm::CompleteRegressionFisherEstimation< class ::statiskit::glm::NominalRegression > >::Estimator >::Type, autowig::Held< class ::statiskit::glm::CompleteRegressionFisherEstimation< class ::statiskit::glm::NominalRegression >::Estimator >::Type >();
    }
