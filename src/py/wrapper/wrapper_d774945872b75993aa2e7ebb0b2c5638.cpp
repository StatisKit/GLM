...
void wrapper_d774945872b75993aa2e7ebb0b2c5638()
{
    ...
    boost::python::class_< class ::statiskit::glm::NegativeBinomialRegressionFisherEstimation::Estimator, autowig::Held< class ::statiskit::glm::NegativeBinomialRegressionFisherEstimation::Estimator >::Type, boost::python::bases< class ::statiskit::glm::ScalarRegressionFisherEstimation< class ::statiskit::glm::NegativeBinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator > > class_d774945872b75993aa2e7ebb0b2c5638("Estimator", "", boost::python::no_init);
    ...
    {
        boost::python::implicitly_convertible< autowig::Held< class ::statiskit::glm::NegativeBinomialRegressionFisherEstimation::Estimator >::Type, autowig::Held< class ::statiskit::glm::ScalarRegressionFisherEstimation< class ::statiskit::glm::NegativeBinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator >::Type >();
    }
