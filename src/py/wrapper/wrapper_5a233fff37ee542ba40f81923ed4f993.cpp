...
namespace boost
{
    template <> autowig::Wrap_5a233fff37ee542ba40f81923ed4f993 const volatile * get_pointer<autowig::Wrap_5a233fff37ee542ba40f81923ed4f993 const volatile >(autowig::Wrap_5a233fff37ee542ba40f81923ed4f993 const volatile *c) { return c; }
...
void wrapper_5a233fff37ee542ba40f81923ed4f993()
{
    ...
    boost::python::class_< autowig::Wrap_5a233fff37ee542ba40f81923ed4f993, autowig::Held< autowig::Wrap_5a233fff37ee542ba40f81923ed4f993 >::Type, boost::python::bases< class ::statiskit::glm::ConstrainedRegressionFisherEstimation< class ::statiskit::glm::OrdinalRegression >::Estimator >, boost::noncopyable > class_5a233fff37ee542ba40f81923ed4f993("_PolymorphicCopy_5a233fff37ee542ba40f81923ed4f993", "", boost::python::no_init);

    if(autowig::Held< struct ::statiskit::PolymorphicCopy< struct ::statiskit::UnivariateConditionalDistributionEstimation::Estimator, class ::statiskit::glm::OrdinalRegressionFisherEstimation< class ::statiskit::glm::ConstrainedRegressionFisherEstimation< class ::statiskit::glm::OrdinalRegression > >::Estimator, class ::statiskit::glm::ConstrainedRegressionFisherEstimation< class ::statiskit::glm::OrdinalRegression >::Estimator > >::is_class)
    {
        boost::python::implicitly_convertible< autowig::Held< autowig::Wrap_5a233fff37ee542ba40f81923ed4f993 >::Type, autowig::Held< struct ::statiskit::PolymorphicCopy< struct ::statiskit::UnivariateConditionalDistributionEstimation::Estimator, class ::statiskit::glm::OrdinalRegressionFisherEstimation< class ::statiskit::glm::ConstrainedRegressionFisherEstimation< class ::statiskit::glm::OrdinalRegression > >::Estimator, class ::statiskit::glm::ConstrainedRegressionFisherEstimation< class ::statiskit::glm::OrdinalRegression >::Estimator > >::Type >();
