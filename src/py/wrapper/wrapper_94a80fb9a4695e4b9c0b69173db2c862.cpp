...
void wrapper_94a80fb9a4695e4b9c0b69173db2c862()
{
    ...
    class_94a80fb9a4695e4b9c0b69173db2c862.def(boost::python::init< class ::statiskit::UnivariateConditionalData const * >(""));
    class_94a80fb9a4695e4b9c0b69173db2c862.def(boost::python::init< class ::statiskit::glm::BinomialRegression const *, class ::statiskit::UnivariateConditionalData const * >(""));
