...
void wrapper_cca053704b1954389d77198ecac1cc90()
{
    ...
    class_cca053704b1954389d77198ecac1cc90.def(boost::python::init< struct ::statiskit::MultivariateData const * >(""));
    class_cca053704b1954389d77198ecac1cc90.def(boost::python::init< class ::statiskit::glm::NominalRegression const *, struct ::statiskit::MultivariateData const * >(""));
