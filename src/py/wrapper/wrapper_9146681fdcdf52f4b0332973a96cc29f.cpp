...
void wrapper_9146681fdcdf52f4b0332973a96cc29f()
{
    ...
    class_9146681fdcdf52f4b0332973a96cc29f.def(boost::python::init< struct ::statiskit::MultivariateData const * >(""));
    class_9146681fdcdf52f4b0332973a96cc29f.def(boost::python::init< class ::statiskit::glm::NegativeBinomialRegression const *, struct ::statiskit::MultivariateData const * >(""));
