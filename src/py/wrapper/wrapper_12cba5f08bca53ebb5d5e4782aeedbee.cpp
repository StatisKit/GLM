...
void wrapper_12cba5f08bca53ebb5d5e4782aeedbee()
{
    ...
    boost::python::class_< class ::statiskit::glm::BinomialRegression, autowig::Held< class ::statiskit::glm::BinomialRegression >::Type, boost::python::bases< struct ::statiskit::glm::UnivariateDiscreteGeneralizedLinearModel< struct ::statiskit::glm::BinomialLink > > > class_12cba5f08bca53ebb5d5e4782aeedbee("BinomialRegression", "", boost::python::no_init);
    class_12cba5f08bca53ebb5d5e4782aeedbee.def(boost::python::init< unsigned int const &, class ::statiskit::glm::ScalarPredictor const &, struct ::statiskit::glm::BinomialLink const & >(""));
    ...
    {
        boost::python::implicitly_convertible< autowig::Held< class ::statiskit::glm::BinomialRegression >::Type, autowig::Held< struct ::statiskit::glm::UnivariateDiscreteGeneralizedLinearModel< struct ::statiskit::glm::BinomialLink > >::Type >();
    }
