...
void wrapper_d18675c1fb1c538391662efe54c9c111()
{
    ...
    class_d18675c1fb1c538391662efe54c9c111.def(boost::python::init<  >(""));
    class_d18675c1fb1c538391662efe54c9c111.def(boost::python::init< class ::statiskit::glm::PoissonRegression const *, class ::statiskit::UnivariateConditionalData const * >(""));
    class_d18675c1fb1c538391662efe54c9c111.def(boost::python::init< class ::statiskit::glm::QuantitativeScalarRegressionFisherEstimation< class ::statiskit::glm::PoissonRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation > const & >(""));

    if(autowig::Held< class ::statiskit::glm::QuantitativeScalarRegressionFisherEstimation< class ::statiskit::glm::PoissonRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation > >::is_class)
    {
