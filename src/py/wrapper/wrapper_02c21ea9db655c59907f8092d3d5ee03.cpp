...
void wrapper_02c21ea9db655c59907f8092d3d5ee03()
{
    ...
    class_02c21ea9db655c59907f8092d3d5ee03.def(boost::python::init< class ::statiskit::UnivariateConditionalData const * >(""));
    class_02c21ea9db655c59907f8092d3d5ee03.def(boost::python::init< class ::statiskit::glm::OrdinalRegression const *, class ::statiskit::UnivariateConditionalData const * >(""));
