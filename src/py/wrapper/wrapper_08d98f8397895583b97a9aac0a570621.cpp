...
void wrapper_08d98f8397895583b97a9aac0a570621()
{
    ...
    void  (::statiskit::glm::GeneralizedLinearModel< ::statiskit::DiscreteUnivariateConditionalDistribution, ::statiskit::BinomialLink >::*method_pointer_7b580bf0ce155538ae0ddd86aa3f0944)(class ::statiskit::ScalarPredictor const &) = &::statiskit::glm::GeneralizedLinearModel< struct ::statiskit::DiscreteUnivariateConditionalDistribution, struct ::statiskit::BinomialLink >::set_predictor;
    struct ::statiskit::BinomialLink * (::statiskit::glm::GeneralizedLinearModel< ::statiskit::DiscreteUnivariateConditionalDistribution, ::statiskit::BinomialLink >::*method_pointer_26ae6ddc341958829e655b8c3c81bb6c)() const = &::statiskit::glm::GeneralizedLinearModel< struct ::statiskit::DiscreteUnivariateConditionalDistribution, struct ::statiskit::BinomialLink >::get_link;
    ...
    class_08d98f8397895583b97a9aac0a570621.def("set_predictor", method_pointer_7b580bf0ce155538ae0ddd86aa3f0944, "");
