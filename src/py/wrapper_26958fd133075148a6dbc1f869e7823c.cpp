...
void wrapper_26958fd133075148a6dbc1f869e7823c()
{
    ...
    double const & (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::BinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_66061bdc78ad560294c56b270e4fb911)() const = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_epsilon;
    void  (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::BinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_ed035ecc1a07585c931eb1889403ca78)(double const &) = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_epsilon;
    unsigned int const & (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::BinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_0f63b8cd57b05333a887a882907b2d22)() const = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_maxits;
    void  (::statiskit::glm::ScalarFisherEstimation< ::statiskit::glm::BinomialRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_c78ebe4bea2957ce97590b31bf62a9c6)(unsigned int const &) = &::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_maxits;
    ...
    boost::python::class_< autowig::Wrap_26958fd133075148a6dbc1f869e7823c, autowig::Held< autowig::Wrap_26958fd133075148a6dbc1f869e7823c >::Type, boost::python::bases< struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation::Estimator >, boost::noncopyable > class_26958fd133075148a6dbc1f869e7823c("Estimator", "", boost::python::no_init);
    class_26958fd133075148a6dbc1f869e7823c.def("get_epsilon", method_pointer_66061bdc78ad560294c56b270e4fb911, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_26958fd133075148a6dbc1f869e7823c.def("set_epsilon", method_pointer_ed035ecc1a07585c931eb1889403ca78, "");
    class_26958fd133075148a6dbc1f869e7823c.def("get_maxits", method_pointer_0f63b8cd57b05333a887a882907b2d22, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_26958fd133075148a6dbc1f869e7823c.def("set_maxits", method_pointer_c78ebe4bea2957ce97590b31bf62a9c6, "");
    ...
    if(autowig::Held< class ::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator >::is_class)
    {
        ...
        //boost::python::objects::class_value_wrapper< autowig::Held< class ::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator >::Type, boost::python::objects::make_ptr_instance< class ::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator, boost::python::objects::pointer_holder< autowig::Held< class ::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator >::Type, class ::statiskit::glm::ScalarFisherEstimation< class ::statiskit::glm::BinomialRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator > > >();
    }
