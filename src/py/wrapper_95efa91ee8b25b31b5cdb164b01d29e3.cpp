...
void wrapper_95efa91ee8b25b31b5cdb164b01d29e3()
{
    ...
    double const & (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::OrdinalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_cc5bc52a0c9555c691143beaccc30d08)() const = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::OrdinalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_epsilon;
    void  (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::OrdinalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_8080b317280058fd957e200152f879b1)(double const &) = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::OrdinalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_epsilon;
    unsigned int const & (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::OrdinalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_9759e420a15b5872abc1a28c0e517e8b)() const = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::OrdinalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::get_maxits;
    void  (::statiskit::glm::CategoricalFisherEstimation< ::statiskit::glm::OrdinalRegression, ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::*method_pointer_97ce9b36a5065f0ca29098a343f2c3a0)(unsigned int const &) = &::statiskit::glm::CategoricalFisherEstimation< class ::statiskit::glm::OrdinalRegression, struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation >::Estimator::set_maxits;
    ...
    boost::python::class_< autowig::Wrap_95efa91ee8b25b31b5cdb164b01d29e3, autowig::Held< autowig::Wrap_95efa91ee8b25b31b5cdb164b01d29e3 >::Type, boost::python::bases< struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation::Estimator >, boost::noncopyable > class_95efa91ee8b25b31b5cdb164b01d29e3("Estimator", "", boost::python::no_init);
    class_95efa91ee8b25b31b5cdb164b01d29e3.def("get_epsilon", method_pointer_cc5bc52a0c9555c691143beaccc30d08, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_95efa91ee8b25b31b5cdb164b01d29e3.def("set_epsilon", method_pointer_8080b317280058fd957e200152f879b1, "");
    class_95efa91ee8b25b31b5cdb164b01d29e3.def("get_maxits", method_pointer_9759e420a15b5872abc1a28c0e517e8b, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_95efa91ee8b25b31b5cdb164b01d29e3.def("set_maxits", method_pointer_97ce9b36a5065f0ca29098a343f2c3a0, "");
