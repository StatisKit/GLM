...
void wrapper_886633d13cd15b79a7a65445135a5ac8()
{
    ...
    if(autowig::Held< struct ::statiskit::VectorLink >::is_class)
    {
        ...
        //boost::python::objects::class_value_wrapper< autowig::Held< struct ::statiskit::VectorLink >::Type, boost::python::objects::make_ptr_instance< struct ::statiskit::VectorLink, boost::python::objects::pointer_holder< autowig::Held< struct ::statiskit::VectorLink >::Type, struct ::statiskit::VectorLink > > >();
        //boost::python::implicitly_convertible< autowig::Held< autowig::Wrap_886633d13cd15b79a7a65445135a5ac8 >::Type, autowig::Held< struct ::statiskit::VectorLink >::Type >();
    }    
